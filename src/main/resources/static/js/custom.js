...
/*function setLiActive(pathname = window.location.pathname)
{
	...
	$('.nav-first-level > a').each(function(){
		
   	 	var iterPath=$(this).attr('href');
   	 	
		if(pathname==iterPath)
		{
			//console.log("Matched: "+iterPath);
	...
	$('.nav-third-level > li > a').each(function(){
   	 	var iterPath=$(this).attr('href');
		if(pathname==iterPath)
		{
			//console.log("Matched: "+iterPath);
	...
	// Added By Er.Mohit for fourth level :)
	$('.nav-fourth-level > li > a').each(function(){
   	 	var iterPath=$(this).attr('href');
		if(pathname==iterPath)
		{
			//console.log("Matched: "+iterPath);
